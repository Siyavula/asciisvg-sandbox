...
# ========================================================================================
	...
	def angle_arc(self, center=[0,0], radius=1, start_deg=0, stop_deg=45, text="A"):
		...
		# Text
		self.text([center[0] + 1.25*radius*math.cos((angle_stop-angle_start)/2),center[1] + 1.25*radius*math.sin((angle_stop-angle_start)/2)], str(text))
